#!/usr/bin/perl -w
# $Id: load_alignments_gff3.pl,v 1.1.2.1 2009-07-19 09:11:34 sheldon_mckay Exp $
...
my $usage = "Usage: aln2hit.pl -u username -p password -d database [-f format, -v, -n] file1, file2 ... filen\n\n";
