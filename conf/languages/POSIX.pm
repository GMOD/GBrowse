# do not remove the { } from the top and bottom of this page!!!
{
   ...
   SHOWING_FROM_TO => 'Showing %s Kbp from %s, positions %s to %s',

   SEARCH_INSTRUCTIONS => <<END,
Search using a sequence name, gene name,
locus, oligonucleotide (15 bp minimum) or other landmark. The wildcard
...
END
   ...
   ACCEPT   => 'Accept Changes and Return...',
