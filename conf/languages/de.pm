...
END
 ...
 OPTIONS_UPDATED   => 'Eine neue Site-Konfiguration ist in Kraft; Alle Seiteneinstellungen wurden auf ihre Standardwerte zur�ckgesetzt',

 SEND_TO_GALAXY    => 'Diese Region an Galaxy schicken',

 NO_DAS            => 'Installationsfehler: Bio::Das Modul muss f�r das Funktionieren von DAS URLs installiert sein. Bitte den Site Webmaster informieren.',
