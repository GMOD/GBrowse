...
If you don't want the file upload text field to appear, set this to
true. This disables file uploading and remote DAS tracks completely,
even if the user tries to reverse-engineer the gbrowse form.
