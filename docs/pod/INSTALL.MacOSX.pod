...
=item 3. The MySQL database, version 3.23.39 or higher (optional)
...
=item 4. Perl, version 5.6 or higher
...
=item 6. BioPerl package, vers 1.5.2 or higher

  http://www.bioperl.org/

=item 7. Apache 1.3* or 2.0* (http://www.apache.org)
...
NOTE: X11 will come preinstalled with OS X 10.3 and greater.
...
=item 2. Creating users for MySQL (optional)

Mysql is a popular database option, though not the only one.
If you install MySQL you will have to create
...
=item Installing MySQL from source (optional)
...
=item Installing MySQL from a precompiled package (optional)
...
See http://www.paginar.net/matias/articles/gd_x_howto.html for
another description of installing these libraries manually if you
...
=item 7. Installing DBD::mysql (optional)
...
$Id: INSTALL.MacOSX.pod,v 1.3.14.1 2007-03-20 13:41:48 briano Exp $
