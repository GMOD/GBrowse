...
=item E) Bioperl version 1.2.3 or higher -- L<http://www.bioperl.org>

While the basic functionality of GBrowse will work with Bioperl 1.2.3, 
Bioperl 1.4 contains fixes for certain features.  If you find that a 
particular feature is not working as expected, upgrade to Bioperl 1.4.
...
in the correct path.  If you find that after installing GBrowse, you get
errors saying "The landmark named XXXX is not recognized...", try uninstalling
and reinstalling GBrowse and give the "short" filenames for directory paths.
For example,

  ** Please indicate the location of the following Web Server directories:
        "conf" directory ([q]uit) [C:/Program Files/Apache Group/Apache2/conf]
        c:/progra~1/apache~1/apache2/conf
...
GBrowse on top of Oracle, PostgreSQL and BioSQL databases see
...
=head2 5. POPULATING THE DATABASE (MySQL)
...
=head2 8. CREATING YOUR OWN GENOME DATABASE
...
=head2 9. MAKING THE BROWSER RUN FASTER
...
=head2 10. MAKING THE BROWSER RUN SAFER
...
GBrowse run, make sure you are using Bioperl 1.2.2!

=head2 12. THE GBROWSE_IMG SCRIPT
...
=head2 14. THE GENBANK/EMBL PROXY
...
=head2 15. UPDATING THE BROWSER WITHOUT REENTERING YOUR DIRECTORY SETTINGS
...
=head2 17. FEATURE WISH LIST (updated June 6, 2003)
...
=head2 18. SUPPORT AND BUG REPORTS
