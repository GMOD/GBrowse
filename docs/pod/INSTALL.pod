...
shell commands will remove old image files and unused directories:
...
%apache%/htdocs/gbrowse/js 

where %apache% is the path to your apache installation folder. For example,
if your apache installation path is D:/apache, copy those js files into:

D:/apache/htdocs/gbrowse/js

And then copy all balloon image files into the folder:

%apache%/htdocs/images/balloons

=head2 18. BUG REPORTS AND SUPPORT REQUESTS
...
L<mailto:gmod-gbrowse@lists.sourceforge.net>. 
