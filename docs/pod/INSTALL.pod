...
=item E) BioPerl version 1.6 or higher -- L<http://www.bioperl.org>

Or 'bioperl-live'.

=item F) Bio::Graphics 1.97 or higher

Bio::Graphics used to be part of BioPerl but has been broken out as a 
separate package that can be installed from CPAN.
