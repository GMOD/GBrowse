...
=head2 1. MACINTOSH OS X INSTALL

Go to the following URL:

  ftp://ftp.wormbase.org/pub/people/tharris/macosx/packages
...
"ActivePerl."  This is a little confusinb because web site tries to
