...
=item E) Bioperl version 1.4 or higher -- L<http://www.bioperl.org>

While the basic functionality of GBrowse will work with Bioperl 1.4, 
bioperl-live (in the cvs repository) contains fixes for certain features. 
If you find that a particular feature is not working as expected, upgrade
to bioperl-live (or Bioperl 1.5 when it is released).
