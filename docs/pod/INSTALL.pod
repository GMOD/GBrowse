...
step.  Also, I have had difficulties with the ppm files for GBrowse
and ActiveState Perl 5.6.1.  Please use ActiveState Perl 5.8. 
Launch the Windows command shell by choosing "Run..." and then
