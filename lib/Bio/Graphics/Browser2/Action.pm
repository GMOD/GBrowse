...
sub ACTION_navigate {
    ...
    $render->state->{view_start} = ($q->param('view_start') >= 0)? $q->param('view_start') : $render->state->{view_start},
    $render->state->{view_stop}  = ($q->param('view_stop')  >= 0)? $q->param('view_stop')  : $render->state->{view_stop},
